...
const pelis = (array) => {
  let categoriasPelis = [];
  for (peliculas of array) {
    for (categorias of peliculas.categories) {
      if (!categoriasPelis.includes(categorias)) {
        categoriasPelis.push(categorias);
      }
    }
  }
  return categoriasPelis;
};
